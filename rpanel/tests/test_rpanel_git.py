...
from rpanel.hosting.git_manager import (
    clone_repository,
    pull_latest,
    switch_branch,
    rollback_deployment,
...
class TestGitManager(unittest.TestCase):
    ...
    def test_clone_repository_success(
        self, mock_listdir, mock_makedirs, mock_exists, mock_run, mock_get_doc, mock_db
    ):
        # Setup
    ...
    def test_clone_repository_not_empty(
        self, mock_exists, mock_run, mock_get_doc, mock_db
    ):
        # Setup
        mock_get_doc.return_value = self.mock_website
